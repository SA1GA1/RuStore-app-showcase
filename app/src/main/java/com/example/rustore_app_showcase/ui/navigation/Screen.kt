...
sealed class Screen(val route: String) {
    ...
    object Showcase : Screen("showcase?categoryName={categoryName}") {
        fun createRoute(categoryName: String?) = if (categoryName != null) "showcase?categoryName=$categoryName" else "showcase"
    }
